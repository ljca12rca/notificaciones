...
public class Main {
    public static void main(String[] args) {
        ...
        config.registerProvider(TypeChannel.PUSH, FirebaseProvider.class);
        ...
        config.configureChannel(TypeChannel.PUSH, pushConfig);
        ...
        config.registerProvider(TypeChannel.EMAIL, MailgunProvider.class);
        ...
        config.configureChannel(TypeChannel.EMAIL, mailgunConfig);
